...
@dataclass
class IntentScore:
    """Input from intent_engine.py (eye-based)"""
...
@dataclass
class GestureResult:
    """Input from hand_gesture_engine.py"""
...
class GazeFusionEngine:
    ...
    def fuse(
        ...
        Args:
            intent_score: Eye-based intent from intent_engine.py (can be None)
            gesture_result: Hand gesture from hand_gesture_engine.py (can be None)
    ...
    def _gesture_to_command(self, gesture_type: str) -> Optional[CommandType]:
        ...
        This is a simplified mapping; full mapping is in gesture_command_map.py
        """
        gesture_map = {
...
from gesture_fusion import GazeFusionEngine, FusionConfig, FusionMode, IntentScore
...
from gesture_fusion import IntentScore as FusionIntentScore
