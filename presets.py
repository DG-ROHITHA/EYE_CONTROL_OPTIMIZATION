...
-------------------------------------
from presets import GamingPreset
    ...
    if len(sys.argv) > 1:
        ...
        if command == 'list':
            ...
            if len(sys.argv) > 2:
                ...
                print("Usage: python presets.py info <preset_name>")
        ...
        print("  python presets.py info balanced")
        print("  python presets.py example")
        print("  python presets.py interactive")
        
        print("\n📖 Quick Start:")
        print("  1. Import: from presets import PresetManager")
